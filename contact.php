        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    <h1><span class="glyphicon glyphicon-user"></span> Priya Jain</h1>
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: preeyajain09@gmail.com<br>
                        <span class="glyphicon glyphicon-phone"></span> Mobile: 8875521333
                    </p>
                </div>
                <div class="col-md-6">
                    <form>
