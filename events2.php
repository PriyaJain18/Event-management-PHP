        ...
        <div class="content"><!--body content holder-->
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            <h1 class="title">Thanksgiving by Mr. Wang</h1><!--event content title-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            <h1 class="title">Nina Dobrev birthday Bash</h1><!--event content title-->
                            <p class="location"><!--event content location-->
                            Lorem ipsum dolor sit amet consectetur adipisqui! Facilis, expedita cupiditate!
                            </p>
                            <p class="definition"><!--event content definition-->
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                            When an unknown printer took a galley of type and scrambled it to make a type specimen book.
            ...
            <div class="row">
                <section>
                    <div class="container">
                        <div class="date col-md-1"><!--date holder with 1 grid column-->
                            <span class="month">SEPT</span><br><!--month-->
                            <hr class="line"><!--css modified horizontal line-->
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            <h1 class="title">Mr. and Mrs. Smith Wedding Anniversary</h1><!--event content title-->
                            <p class="location"><!--event content location-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            <h1 class="title">IBM Company Dinner</h1><!--event content title-->
                            <p class="location"><!--event content location-->
