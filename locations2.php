                ...
                <section>
                    <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>Cloak & Petal:THE ULTIMATE PRIVATE DINING EXPERIENCE</h5><!--content title-->
                                                <p>
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">Cloak & Petal: Private Dining Room</h1><!--location title-->
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                        ...
                        <div class="modal fade" id="ananasbar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--location modal content-->
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><!--close button on top-->
                                        <h4 class="modal-title" id="myModalLabel"> The Saffron Boutique</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>Lorem ipsum dolor sit.</h5><!--content title-->
                                                <p>
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">The saffron Boutique</h1><!--location title-->
                            <p class="location">Near marine drive,mumbai</p><!--location secondary content-->
                            <p class="definition">
                            It is the Mumbai Sophisticate’s adult playground.
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="modal fade" id="argyle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--location modal content-->
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><!--close button on top-->
                                        <h4 class="modal-title" id="myModalLabel">Jekyll & Hyde Club</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">The Jekyll and hyle club
                            </h1>
                            <p class="location">The Rocks 18 connaught Street</p>
                            <p class="definition">It is one of the most intriguing historical clubs visited by Foreigners since 2001.
                                And our landmark venue, delhi has a rich history all of its own. The sandstone walls that house
                                It has some interesting sights well before we all hit the dance floor.</p>
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        ...
                                        <h4 class="modal-title" id="myModalLabel"> Cibo Matto</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>THE BEST OF ITALIAN FOOD YOU'D EVER HAVE</h5>
                                                <p>
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">ciba matto</h1>
                            <p class="location">45 South Wharf Promenade</p>
                            <p class="definition">Venue where you can dink drink and party like Oktoberfest never ended.
